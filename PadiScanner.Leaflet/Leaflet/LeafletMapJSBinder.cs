...
namespace PadiScanner.Leaflet.Leaflet;
...
internal class LeafletMapJSBinder : IAsyncDisposable
{
    ...
    {
        return await (_leafletMapModule ??= JSRuntime.InvokeAsync<IJSObjectReference>("import", "./_content/PadiScanner.Leaflet/js/leaflet-map.js").AsTask());
    }
